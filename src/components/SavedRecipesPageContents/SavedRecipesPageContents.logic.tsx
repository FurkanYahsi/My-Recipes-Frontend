...
import { getSavedRecipes } from '../../services/RecipeServices/RecipeService.export';
...
const useSavedRecipesPageContents = () => {
    ...
    useEffect(() => { // Fetch saved recipes when the page refreshes
        setLoading(true);
...
export default useSavedRecipesPageContents
